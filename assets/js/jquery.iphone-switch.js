...
jQuery.fn.iphoneSwitch = function(start_state, switched_on_callback, switched_off_callback, options) {
	...
	return this.each(function() {
		...
		jQuery(this).click(function() {
			if(state == 'on') {
				jQuery(this).find('.iphone_switch').animate({backgroundPosition: -53}, settings.switch_speed, function() {
				...
				jQuery(this).find('.iphone_switch').animate({backgroundPosition: 0}, settings.switch_speed, function() {
